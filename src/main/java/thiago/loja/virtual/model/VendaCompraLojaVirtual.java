...
public class VendaCompraLojaVirtual implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "end_entrega_id", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "end_entrega_fk"))
	private Endereco enderecoentrega;

	@ManyToOne
	@JoinColumn(name = "end_cobranca_id", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "end_cobranca_fk"))
	...
	@ManyToOne
	@JoinColumn(name = "form_pagamento_id", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "form_pagamento_fk"))
